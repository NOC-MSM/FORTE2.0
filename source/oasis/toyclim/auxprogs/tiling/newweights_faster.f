...
c      read in the ocean land mask
      ...
      write(6,*) "atmosphere thinks it's a sea point "
      write(6,*) "ocean thinks it's a land point "
      write(6,*) " weight 896 = ",wt(1,896)
...
c     points do not contribute
      ...
      if(nsea.eq.0 .and. iland(ival, jval).eq.0)then
...
ccccccccccccccccccccccc
      ...
      open(unit=91, file='OUTPUT/at31topa.newer',form='unformatted')
      write(91) cladress
      write(91) iadressnew
      write(91) clweight
      write(91)wtnew
      ...
      read(5,*)itest
      do i=1,20
c     write(6,*)i,wtnew(i,itest),wt(i,itest)
      io=mod(iadressnew(i,itest),nxo)
c     jo=1+iadressnew(i,itest)/nxo
      jo=1+iadressnew(i,itest)/nxo
      write(6,*)i,wt(i,itest),wtnew(i,itest),iadress(i,itest),
     1   iadressnew(i,itest),io,jo
     1   ,ilando(io,jo)
      end do
      stop
      end
