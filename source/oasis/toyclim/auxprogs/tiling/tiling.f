...
c      read in the ocean land mask
      do j=nyo,1,-1
c     write(6,"(90i1)")(10*ilando(i,j),i=1,60)
      end do
c     write(6,*)
      do j=nyo,1,-1
c     write(6,"(90i1)")(10*ilando(i,j),i=61,120)
      end do
c     write(6,*)
      do j=nyo,1,-1
c     write(6,"(90i1)")(10*ilando(i,j),i=121,180)
      end do
...
c      each contributing ocean gridpoint
      ...
      if(itest.eq.itestval)write(6,"(2i10,f10.2,5i10)")
...
c      ------------------
      ...
      if(itest.eq.itestval)write(6,*)itest,ofrac(ival,jval)
