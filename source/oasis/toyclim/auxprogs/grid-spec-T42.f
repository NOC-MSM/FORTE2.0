      ...
      PARAMETER(NN=42,MM=42,NL=15,IROM=0,ISYM=0,NNOROG=42,IDATE=4
     : ,IULCC=0)
      PARAMETER(MGD=128,JGD=65,NLD=15)
...
C
      ...
      read(59,*)gs
      close(59)
      CALL PRZNT(GS,MGD,JGD,1,' NEW OROG ',.TRUE.,NPC1,GAV,ISYM,FINC)
C
C Setup utf 
C
      IF(LUTF)THEN
...
C
 ...
 6        WRITE(NPC1,1000)L,(NINT(SCALE*GAV(J,L)),J=JGH,JGD)
     ...
     : ,LZONAL,LPREP,LFORS,LFORSH
      ...
      DATA P/0.0185, 0.0596, 0.1057, 0.1520, 0.1968, 0.2407, 0.2865
     1, 0.3382, 0.4002, 0.4765, 0.5687, 0.6740, 0.7844, 0.8871, 0.9673/
