...
c     do j=1,jg
c     do j=jg-5,jg
c        write (30,'(15f8.3)')(gsg(i,j),i=97,111)
c     enddo

      do j=jg,1,-1
c        write (30,'(128I1)')(nint((gsg(i+mgpp,j)/
...
c     do j=2*jg,1,-1
      do j=1,2*jg
      write (30,'(128I1)')(flipmap(i,j),i=1,mg)
      end do
      open(4,file="fort.30.safe")
      do j=1,2*jg
      write (4,'(128I1)')(flipmap(i,j),i=1,mg)
      end do
  
      do j=22,33
      write (30,'(128I1)')(flipmap(i,j),i=86,114)
      end do
